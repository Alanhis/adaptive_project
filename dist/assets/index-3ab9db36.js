...
`;const l="/assets/logo-a52b8ed2.svg",m="/assets/map-39ef8ea1.svg",d="/assets/whatapp-f2fa392a.svg";document.querySelector("header").innerHTML=` 
...
`;const u="/assets/image-1-dd9c478d.jpg",p="/assets/point-left-0178e840.svg",g="/assets/point-right-be17c049.svg";let n=1;document.querySelector("main").innerHTML=` 
...
</div>`;document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementsByClassName("btn-left")[0],c=document.getElementsByClassName("btn-right")[0],a=ItcSlider.getOrCreateInstance(".slider",{loop:!0});t.addEventListener("click",()=>{a.slidePrev(),--n,n==0&&(n=4),document.querySelector(".scroll-main-text").innerHTML=` ${n}<span class="scroll-unactive-text">/4</span> `}),c.addEventListener("click",()=>{a.slideNext(),++n,n==5&&(n=1),document.querySelector(".scroll-main-text").innerHTML=` ${n}<span class="scroll-unactive-text">/4</span> `})});const v="/assets/instagram-b073ae20.svg",f="/assets/telegram-3c86afef.svg";document.querySelector("footer").innerHTML=` 
...
`;b();const y="/assets/image-2-060d19d2.jpg";[...document.getElementsByClassName("second-container")].map(t=>{t.innerHTML=` 
